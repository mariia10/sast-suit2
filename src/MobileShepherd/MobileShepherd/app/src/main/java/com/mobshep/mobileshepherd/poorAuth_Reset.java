...
public class poorAuth_Reset extends Activity {
  ...
  public void reset(View v) {
    ...
    if (CheckQ1.contentEquals("") || CheckQ2.contentEquals("")) {
      Toast empty =
          Toast.makeText(poorAuth_Reset.this, "Empty Fields Detected.", Toast.LENGTH_SHORT);
      empty.show();
    }

    if (CheckQ1.equalsIgnoreCase("Chicken") && CheckQ2.equalsIgnoreCase("Meade")) {
      Toast reset = Toast.makeText(poorAuth_Reset.this, "Password Reset.", Toast.LENGTH_SHORT);
      reset.show();
      ...
      Toast invalid = Toast.makeText(poorAuth_Reset.this, "Invalid answers.", Toast.LENGTH_SHORT);
      invalid.show();
    }
  }
