...
public class ids3Login extends MainActivity {
  ...
  public void loginClicked(View v) {
    ...
    if ((etUsername.getText().toString().equals(username) == true)
        && (etPassword.getText().toString().equals(password) == true)) {
      Toast loggedIn = Toast.makeText(ids3Login.this, "Logged in!", Toast.LENGTH_LONG);
      loggedIn.show();
      ...
      Toast error = Toast.makeText(ids3Login.this, "Invalid Credentials!", Toast.LENGTH_LONG);
      error.show();
    }
  }
