 ...
 * @author Sean Duggan
 */
public class Insecure_Data_Storage1 extends MainActivity
    implements NavigationView.OnNavigationItemSelectedListener {

  private static String DB_PATH =
      "/data/data/com.mobshep.mobileshepherd/databases/InsecureDataStorage1/";
  ...
  private void InsertData(String user, String pass) throws IOException {
    ...
    try {
      ...
      SQLiteStatement stmt =
          Users.compileStatement("INSERT INTO Users (name, password) VALUES (?,?);");
      stmt.bindString(1, user);
      stmt.bindString(2, util.Obfuscation1(pass));
      stmt.execute();

      Snackbar insert =
          Snackbar.make(findViewById(android.R.id.content), "Data Inserted!", Snackbar.LENGTH_LONG);
      insert.show();
      ...
      Snackbar error =
          Snackbar.make(
              findViewById(android.R.id.content), "Could not Insert Data.", Snackbar.LENGTH_LONG);
      error.show();
    }
  }
  ...
  public void initialiseTable() {
    ...
    Users.execSQL(
        "INSERT INTO Users (name, password) VALUES ('Root','V2Fyc2hpcHNBbmRXcmVuY2hlcw==');");
  }
}
