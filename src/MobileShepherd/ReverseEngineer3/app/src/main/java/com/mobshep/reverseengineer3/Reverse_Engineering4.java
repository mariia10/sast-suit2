...
public class Reverse_Engineering4 extends Activity {
  ...
  public void checkKey(View v) {
    ...
    if (checkKey.contentEquals(theKey)) {
      ...
      Toast toast = Toast.makeText(Reverse_Engineering4.this, "Valid Key", Toast.LENGTH_LONG);
      toast.show();

    } else {
      Toast toast = Toast.makeText(Reverse_Engineering4.this, "Invalid Key", Toast.LENGTH_LONG);
      toast.show();

      Toast remove = Toast.makeText(Reverse_Engineering4.this, theKey, Toast.LENGTH_LONG);
      remove.show();
    }
  }
}
