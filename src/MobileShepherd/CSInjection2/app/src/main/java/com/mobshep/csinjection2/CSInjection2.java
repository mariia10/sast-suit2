  ...
  private boolean login(String username, String password) throws IOException {
    try {
      try {
        ...
        String query =
            ("SELECT * FROM Users WHERE memName='"
                + username
                + "' AND memPass = '"
                + password
                + "';");
        ...
        Toast error =
            Toast.makeText(
                CSInjection2.this, "An error occurred." + e.toString(), Toast.LENGTH_LONG);
        error.show();
        key.getText().clear();
      ...
      Toast error =
          Toast.makeText(
              CSInjection2.this, "An database error occurred." + e.toString(), Toast.LENGTH_LONG);
      error.show();
    }
  ...
  public void populateTable(Context context, String dbPassword) {
    try {
      ...
      try {
        ...
        db.execSQL(
            "CREATE TABLE Users(memID INTEGER PRIMARY KEY AUTOINCREMENT, memName TEXT, memAge"
        ...
        Toast error =
            Toast.makeText(
                CSInjection2.this,
                "An error occurred, table not initialized." + e.toString(),
                Toast.LENGTH_LONG);
        error.show();
      }
    ...
    try {
      try {
        ...
        Toast error =
            Toast.makeText(
                CSInjection2.this,
                "An error occurred, key was not generated" + e.toString(),
                Toast.LENGTH_LONG);
        error.show();
      }
