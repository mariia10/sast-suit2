...
public class DBHelper {
  ...
  public void insertData(Context context, String Username, String Password) {
    ...
    SQLiteStatement stmt =
        db.compileStatement("INSERT INTO Users (username,password,verified) VALUES(?,?,0)");
  ...
  public void insertKey(Context context, String key) {
    ...
    SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(dbPath, "AHardCodedPassword", null);
  ...
  public void populateTable(Context context, String password) {
    try {
      try {
        ...
        db.execSQL(
            "CREATE TABLE Users(memID INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, password"
                + " VARCHAR, verified Text)");
