...
/**
 * Class to manage interaction of an optional blocking module. This is used to prevent users from
 * getting ahead of themselfs. By deafult this is not enabled <br>
 * <br>
...
public class EnableModuleBlock extends HttpServlet {
   ...
   *
   * @param moduleId The identifier of the module that is locked, preventing the user from
      ...
      if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
        ...
        try {
          ...
          if (notNull && storedResult != null) {
            // Data is good, Module exists! Store it as the Blocking module. Storing the message as
            // well to show
            ...
            out.write(
                "<h3 class='title'>Block Enabled</h3><p>The block has been enabled"
                    + " successfully</p>");
          } else {
