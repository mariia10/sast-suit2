...
/**
 * Insecure Direct Object Reference Bank Challenge <br>
 * <br>
...
public class DirectObjectBankLogin extends HttpServlet {
  ...
  public static String bankForm(
    ...
    bankForm +=
        ""
            ...
            + Encode.forHtmlAttribute(accountNumber)
            ...
            + bundle.getString("bankForm.transferFunds")
            + "'></td></tr>"
            + "</table></form></div><div id='transferLoadingDiv' style='display: none;'>"
            + bundle.getString("bankForm.loading")
            + "</div>"
            ...
            + "</p><div id='refreshFormDiv'><table><tr><td><input type='button' id='refreshFunds'"
            + " onclick='refreshFunds();' value='"
            + bundle.getString("bankForm.refreshBalance")
            + "'></td></tr></table>"
            + "</div><div id='refreshLoadingSign' style='display: none;'>"
            + bundle.getString("bankForm.loading")
            + "</div>"
            ...
            + "<table><tr><td><input type='button' id='logoutButton' onclick='logout();' value='"
            + bundle.getString("bankForm.logoutFromBankAccount")
            + "'></td></tr></table>"
            + "</div><div id='logoutLoadingSign' style='display: none;'>"
            + bundle.getString("bankForm.loading")
            + "</div>"
  ...
  /**
   * Method used to return the bank interaction view for the user that is signed into the Direct
   * Object Bank challenge. This method pulls the local level translation from the session submitted
   *
   * @param accountNumber
   * @param applicationRoot
   * @param ses
   ...
   * @throws SQLException
   */
  public static String bankForm(String accountNumber, String applicationRoot, HttpSession ses)
      throws SQLException {
    // Translation Stuff
