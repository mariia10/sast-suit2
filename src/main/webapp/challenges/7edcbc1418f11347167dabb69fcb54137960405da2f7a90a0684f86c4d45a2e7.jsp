...
<body>
	...
	<div id="contentDiv">
		...
		<div id="hint" style="display: none;">
			...
			<br /> <br />
			<div>
				call findUser('<a id="userContent"></a>');
			</div>
			<br /> <br />
		</div>
		...
		<form id="leForm" action="javascript:;">
			<table>
				<tr>
					<td><%= bundle.getString("challenge.form.pleaseEnter") %><a><%= bundle.getString("challenge.form.customerName") %></a>
						<%= bundle.getString("challenge.form.userLookUp") %></td>
				</tr>
				<tr>
					<td><input style="width: 400px;" id="userIdentity" type="text"
						autocomplete="off" /></td>
				</tr>
				<tr>
					<td>
