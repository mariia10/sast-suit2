	...
	<div class="entry">
		...
		<div id="configureScoreboardDiv">
			<a href="javascript:;" style="text-decoration: none;"
				id="publicScoreboard"
				title="Make the scoreboard public to everybody"><div
					class="menuButton">Make Scoreboard Public</div></a> <a
				href="javascript:;" style="text-decoration: none;"
				id="enableScoreboard"
				title="Enable scoreboard that lists all users regardless of class"><div
					class="menuButton">Enable Scoreboard</div></a> <a href="javascript:;"
				style="text-decoration: none;" id="enableAdminScoreboard"
				title="Disable the scoreboard"><div class="menuButton">Enable
					Scoreboard for Admins</div></a> <a href="javascript:;"
				style="text-decoration: none;" id="disableScoreboard"
				title="Disable the scoreboard"><div class="menuButton">Disable
					Scoreboard</div></a> <br />
			<h2 class="title">Enable Class Specific Scoreboards</h2>
			<p>When users visit the scoreboard, they will only see a list of
				users from their class. Admins that visit the scoreboard will still
				see the scoreboard the default class.</p>
			<a href="javascript:;" style="text-decoration: none;"
				id="classSpecific" title="Enable Class Specific Scoreboard"><div
					class="menuButton">Enable Class Specific Scoreboard</div></a> <a
				href="javascript:;" style="text-decoration: none;"
				id="adminClassSpecific"
				title="Enable Class Specific Scoreboard For Admins"><div
					class="menuButton">Enable Class Specific Scoreboard for
					Admins</div></a>
		</div>
		<br>
															...
															function() {
																if (ajaxCall.status == 200) {
																	...
																	$(
																			"#badData")
																			.html(
																					"<div id='errorAlert'><p> Sorry but there was an error: "
																							+ ajaxCall.status
																							+ " "
																							+ ajaxCall.statusText
																							+ "</p></div>");
